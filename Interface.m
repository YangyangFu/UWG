function [ UWGMonteCarlo ] = Interface( inputPath, interfacePath, bld2Path, bld3Path, bld4Path, bld6Path, bld10Path, bld14Path, resultPath, outputPath )
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

inputPath = 'C:\Users\maoj\Dropbox\UWG_Matlab-master\SensitivityAnalysis\Inputs.xlsx';
interfacePath = 'C:\Users\maoj\Dropbox\UWG_Matlab-master\data\RunUWG_AD_MC.xlsm';
...
for i = 962:1000
    ...
    [res1, ~, ~] = xlsread(resultPath,2,'C2:C25');
    % [res2, ~, ~] = xlsread(resultPath,2,'Y2:Y25');
    
    % Extract outputs
    xlswrite(outputPath,res1',1,['A',num2str(i)]);
    % xlswrite(outputPath,res2',2,['A',num2str(i)]);
