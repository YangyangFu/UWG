function [new_climate_file] = UWGMC(CL_EPW_PATH,CL_EPW,CL_XML_PATH,CL_XML,CL_RE_PATH,CL_RE)
    % =========================================================================
    ...
    if strcmp('Yes',writeXLS)
        ...
        file = 'C:\Users\maoj\Dropbox\UWG_Matlab-master\output\UWGoutput.xlsx'; % This must be full path name
