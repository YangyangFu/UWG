function [new_climate_file,gaTurbanPredict,gaTruralPredict] = UWGGAUrbanRuralSummer(CL_EPW_PATH,CL_EPW,CL_XML_PATH,CL_XML,CL_RE_PATH,CL_RE)
    % =========================================================================
    ...
    try
        ...
        FileName = 'RunUWG_AD_GA_Summer.xlsm';
   ...
   if strcmp('Yes',writeXLS)
        ...
        gaTurbanPredict = zeros (24,1);
        gaTruralPredict = zeros (24,1);
    ...
    gaTurbanPredict = hT_can;
    gaTruralPredict = hT_rur;
